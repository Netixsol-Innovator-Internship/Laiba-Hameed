...
import mainImg from '../../assets/topHeroImg/Landing Main Image.png'
// src/assets/home/topHeroImg/Landing Main Image.png
const Hero = () => {
      ...
      <div className='flex flex-col items-center justify-center'>
        <Container>
          ...
          <div className='w-full grid grid-cols-1 mb-24 md:grid-cols-2 mx-0 gap-12 lg:gap-32 overflow-x-hidden'>
            <div className='w-[100%]'>
              <img className='h-[628px] w-full  object-cover' src={mainImg} alt="" />
            </div>
            <div className='flex flex-col justify-center px-3 md:pl-0 md:pr-18'>
              <div className="flex md:block flex-col justify-center px-6 sm:px-0" >

      ...
      <div className="hidden lg:flex flex-col gap-4">
        ...
        {filterOptions.attributes?.map((item) => (
          <div key={item._id}>
            ...
            <div
              className={`transition-all duration-300 overflow-hidden ${openSections[item._id]
        ...
        <div>
          ...
          <div
            className={`transition-all duration-300 overflow-hidden ${openSections["caffeine"]
              ? "max-h-96 opacity-100"
              : "max-h-0 opacity-0"
              }`}
          >
